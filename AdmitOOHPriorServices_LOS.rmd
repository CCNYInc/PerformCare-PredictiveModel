...
##This Informations are from AdmitOOHPriorServices_LOS table which contain AdmitOOHWithPriorService for the members
...
```{r, mode of AdmitOOHPriorServices}
getmode <- function(v) {
   uniqv <- unique(v)
